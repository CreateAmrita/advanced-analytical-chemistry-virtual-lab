...
var DIFFUSION_CONST, DIFFUSION_LOG_CONST, MASS_CONST, VOLTAGE_CONST, MIN_FINAL_MV_CONST, LOOP_COUNT_CONST; 
...
var unknown_concentration_array=["0.005","0.015","0.025","0.045"]; /** The random values for unknown concentration */
    ...
    return {
        ...
        link: function(scope, element, attrs, dialogs) {
            ...
            function handleComplete() {
                ...
                loadImages(queue.getResult("ascorbic"), "ascorbic", 60, 550, "", 0, polarography_stage, 0.8);
                ...
                setText("graph_text", 330, 50, "", "black", 1, polarography_stage); /** Label for height H */
            ...
            function translationLabels() {
                ...
                scope.heading = _("Polarography - Determination of Unknown Concentration of Vitamin C");
                scope.variables = _("Variables");
                scope.result = _("Result");
                scope.copyright = _("copyright");
                scope.choose_concentration = _("Concentration (mM):");
                scope.load_ascorbic_txt = _("Load Ascorbic Acid Sample");
...
function initialisationOfControls(scope) {
    scope.Concentration = 0.01; /** Initial concentration */
    scope.mVinitial = -150; /** Initial mV */
    scope.mVfinal = -500; /** Final mV */
...
function initialisationOfVariables() {
    ...
    DIFFUSION_CONST = 0.0803648626617462;
    DIFFUSION_LOG_CONST = 1;
    MASS_CONST = 0.0591;
    VOLTAGE_CONST = -315;
    MIN_FINAL_MV_CONST = 300;
...
function initialisationOfImages() {
    getChild("hand").visible = false; /** Initialy hand and ascorbic are not displayed */
    getChild("ascorbic").visible = false;
}
