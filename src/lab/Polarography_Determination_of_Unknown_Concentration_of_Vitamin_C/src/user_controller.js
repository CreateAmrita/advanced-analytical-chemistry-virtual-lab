(function(){
    ...
    .config(['dialogsProvider','$translateProvider',function(dialogsProvider,$translateProvider){
        ...
        $translateProvider.translations(language,{DIALOGS_ERROR:(_("Error")),DIALOGS_ERROR_MSG:(_("Set the initial mV less than or equal to -150 and final mV less than or equal to -300")),DIALOGS_CLOSE:(_("Okay"))}),$translateProvider.preferredLanguage(language);
    }]);
    ...
    */
    function UserController( $mdSidenav, $mdBottomSheet, $log, $q, $scope, $element, Fullscreen, $mdToast, $animate, $translate, dialogs) {
        ...
        $scope.changeConcentration = function() {
            type=$scope.Concentration;
            concentrationEvent($scope); /** Function defined in experiment.js file */
        }

        /** Function for the button Load Ascorbic Sample */
        $scope.loadAscorbic = function() {
            loadAscorbicEvent($scope); /** Function defined in experiment.js file */
        }
